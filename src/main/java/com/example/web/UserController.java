...
import com.example.entity.Date;
...
public class UserController {
     ...
     *
     * @param username           - username of user who wants to be an owner.
     ...
     *
     * @param username           - username of user who wants to be enabled.
     * @param redirectAttributes
     * @return
     */
     ...
     *
     * @param username           - username of user who wants to be a manager.
     * @param redirectAttributes
     * @return
     */
