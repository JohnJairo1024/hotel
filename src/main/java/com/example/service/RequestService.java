...
public class RequestService {
    ...
    /**
     * @param checked - whether or not requests are flagged as checked.
     ...
     *
     * @param id id of request that is being considered.
     ...
     *
     * @param id id of request to be set checked to true.
     ...
     *
     * @param user - user who wants to be an owner.
     */
     ...
     *
     * @param user - user who wants to be a manager.
     */
     ...
     *
     * @param user - user who wants to be enabled.
     */
